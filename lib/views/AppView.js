...
function submitAction(e) {
	...
	if(this.$(formSelector).length > 0){
		...
		//	Il manque le cas des checkbox et radion pour la valeur recupéré dans le form this.val() ???
		...
		if (_.isFunction(this.Controllers[this.CurrentPage.toLowerCase()][action])) {
			this.Controllers[this.CurrentPage.toLowerCase()][action](e, isValid, model);
		}
		else if(_.isFunction(this[action])){
			this[action](e, isValid, model);
		}
		else{
