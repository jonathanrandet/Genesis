...
},{"../../lib/models/ModuleModel":4,"../../modules/Auteur/config":5}],3:[function(require,module,exports){
...
function initialize(data){
	if(!_.isUndefined(data) && !_.isUndefined(data.className)){
		...
		// There is a problem
		throw new Error('ModuleModel : The config file need className attributes');
	}
}
},{"./BaseModel":3,"underscore":8}],5:[function(require,module,exports){
/**
...
},{"C:\\xampp\\htdocs\\mynodeprojects\\Genesis\\vendor\\js\\jquery.js":10}]},{},[12,9,10,11,1,2]);
